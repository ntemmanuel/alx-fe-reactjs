function UserProfile() {
    return (
      <div className="bg-gray-100 p-8 max-w-sm mx-auto my-20 rounded-lg shadow-lg sm:p-4 sm:max-w-xl md:p-8 md:max-w-sm lg:p-8 lg:max-w-sm xl:p-8 xl:max-w-sm 2xl:p-8 2xl:max-w-sm ">
